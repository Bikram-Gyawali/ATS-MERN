...
function InterviewingCandidateDetails() {
  ...
  useEffect(() => {
    const fetchAllInterviewingCanidate = () => {
      // axios POST request
      const options = {
        url: "http://localhost:3003/details/active/interviewing/details",
        method: "POST",
        headers: {
  ...
  const handleSavingDateAndTime = () => {
    ...
    const options = {
      url: "http://localhost:3003/details/active/interviewing/details/dateandtime",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
                    ...
                    <div className="modal-action block m-auto text-center mt-6">
                      <label
                        ...
                        onClick={() => {
                          // axios POST request
                          const options = {
                            url: "http://localhost:3003/details/active/interviewing/details/sendInterviewEmail",
                            method: "POST",
                            headers: {
                              Accept: "application/json",
                              "Content-Type": "application/json;charset=UTF-8",
