...
function ProfileAddTeam() {
  ...
  const data = {
    ...
    latitude: Office_Profile.office_details.office_Value.latitude,
    longitude: Office_Profile.office_details.office_Value.longitude,
  ...
  const post_Method = () => {
    ...
    const options = {
      url: "http://localhost:3003/profile/setup",
      method: "POST",
      headers: {
