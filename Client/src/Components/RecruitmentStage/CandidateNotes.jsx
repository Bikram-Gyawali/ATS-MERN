...
function CandidateNotes({ id }) {
  ...
  const updateComment = () => {
    // axios POST request
    const options = {
      url: "http://localhost:3003/details/active/user/patch/comments",
      method: "PATCH",
      headers: {
  ...
  const postComments = () => {
    // axios POST request
    const options = {
      url: "http://localhost:3003/details/active/user/add/comments",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
  ...
  useEffect(() => {
    ...
    const getComments = () => {
      // axios GET request
      const options = {
        url: "http://localhost:3003/details/active/user/get/comments",
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json;charset=UTF-8",
